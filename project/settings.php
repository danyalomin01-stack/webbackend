...
define('INCLUDE_PATH', '.' . PATH_SEPARATOR . './scripts' . PATH_SEPARATOR . './modules');
...
$urlconf = array(
  '' => array('module' => 'front'),
  '/^api\/profile$/' => array('module' => 'api'),
  '/^api\/profile\/(\d+)$/' => array('module' => 'api', 'auth' => 'auth_basic'),
  '/^profile\/(\d+)$/' => array('module' => 'profile', 'auth' => 'auth_basic'),
